...
class QkeylmTest extends TestCase
{
    ...
    public function testGetDailyJournal()
    {
            ...
            new Response(200, ['X-Foo' => 'Bar'],
                '<body>
                    <div>
                        ...
                        <div id="mainInner">
                            <img class="image-frame" src="http://www.host.org/Enhanced.Eylm/Files/Room/large/my/image.jpg">
                        </div>
                    </div>
                </body>
                '
        ...
        $this->assertTrue(isset($journal['images']['http://www.host.org/Enhanced.Eylm/Files/Room/large/my/image.jpg']));
